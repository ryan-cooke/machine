...
public class XboxControllerTest extends javax.swing.JFrame
{
  ...
  public XboxControllerTest()
  {
    ...
    xp = new XboxController("C:\\Users\\Alex\\Desktop\\XboxController\\dll\\xboxcontroller.dll",1,50,50);
    if (!xp.isConnected())
      setTitle(title + " - Controller disconnected");
    else
      setTitle(title + " - Controller connected");
  ...
  private void initComponents() {
    ...
    jPanel1.setMinimumSize(new Dimension(102, 102));
    jPanel1.setPreferredSize(new Dimension(110, 110));
    ...
    jPanel2.setMinimumSize(new Dimension(102, 102));
    jPanel2.setPreferredSize(new Dimension(110, 110));
    ...
    jPanel3.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 0, 0), 2));
    jPanel3.setPreferredSize(new Dimension(52, 102));
    ...
    jPanel4.setBorder(javax.swing.BorderFactory.createLineBorder(new Color(0, 0, 0), 2));
    jPanel4.setPreferredSize(new Dimension(52, 102));
